...
install_xcframework "${PODS_ROOT}/SnapSDK/SCSDKCoreKit.xcframework" "SCSDKCoreKit" "framework" "ios-arm64_armv7_armv7s" "ios-i386_x86_64-simulator"
install_xcframework "${PODS_ROOT}/SnapSDK/SCSDKCreativeKit.xcframework" "SCSDKCreativeKit" "framework" "ios-arm64_armv7_armv7s" "ios-i386_x86_64-simulator"
